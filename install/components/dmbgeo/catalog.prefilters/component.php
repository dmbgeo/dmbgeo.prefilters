        ...
        if ($arParams["SEF_MODE"] == "Y") {
            ...
            if (isset($arVariables['ELEMENT_CODE']) || isset($arVariables['ELEMENT_ID'])) {
                ...
                if ($arElement = $rsElement->GetNextElement()) {
                    ...
                    $newUrl = str_replace(array("http://www." . $_SERVER['SERVER_NAME'], "https://www." . $_SERVER['SERVER_NAME'], "http://" . $_SERVER['SERVER_NAME'], "https://" . $_SERVER['SERVER_NAME']), "", $arResult['ELEMENT']['PROPERTIES']['FILTER_URL']['~VALUE'] ?? "");
                    if ($newUrl !== "") {
